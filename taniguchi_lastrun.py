...
expName = 'taniguchi'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\nakazawa\\Desktop\\devel\\psychopy-test\\taniguchi_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='1: Human 2:AI Generated, 3:Not Sure',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    trial = data.Routine(
        name='trial',
        components=[text_fixation, image, key_resp, text],
    )
    trial.status = NOT_STARTED
    continueRoutine = True
    # update component parameters for each repeat
    image.setImage('images/1.jpg')
    ...
    while continueRoutine and routineTimer.getTime() < 19.0:
        ...
        if text_fixation.status == NOT_STARTED and tThisFlip >= 3-frameTolerance:
        ...
        if image.status == NOT_STARTED and tThisFlip >= 4-frameTolerance:
            # keep track of start time/frame for later
